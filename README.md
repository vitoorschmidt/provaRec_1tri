# 1INFOs - Prova de Recuperação [1º Trimestre]
...
- Copiar a URL que há no input abaixo ou o endereço completo citado abaixo
  - https://github.com/ldmfabio/provaRec_1tri.git
...
Selecione se deseja publicar repositório _private_ (privado) ou _public_ (público). É **obrigatório** criar um **repositório privado**.
